...
namespace Strabo.Core.TextRecognition
{
    class QGISJsonNeighbothood
    {
        ...
        public static void AddFeature(double x1, double y1,double x2, double y2, double x3 , double y3, double x4 , double y4, string imageID, string PixelToSizeRatio,string TextNonText ,int geo_Ref)
        {
            ...
            _streamPixel += "{\"type\":\"Feature\",\"geometry\":{\"type\":\"Polygon\",\"coordinates\":[[[" + x1.ToString() + "," + (geo_Ref * y1).ToString() + "],[" +
                ...
                x1.ToString() + "," + (geo_Ref * y1).ToString() + "]]]},\"ImageId\":\"" + imageID + "\",\"TextNonText\":\"" + TextNonText + "\",\"PixelToSizeRatio\":\"" + PixelToSizeRatio + "\",},";
        ...
        {
            WriteGeojsonFile();
          //  System.IO.File.WriteAllText(@"C:\Users\narges\Documents\strabo-command-line-master\strabo-command-line-master\Strabo.CommandLine\data\InputImages" + "\\" + filename + "ByPixelsNeighborhood.txt", _streamPixel);
        }
